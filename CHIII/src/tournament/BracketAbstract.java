...
public abstract class BracketAbstract<P> implements Bracket<P> {
    ...
    public BracketAbstract(List<P> participantMatchups) {
        ...
        assert participantMatchupsSizeIsAPowerOf2 :
                "participantMatchups.size() = " + participantMatchups.size() + " is not a power of 2!";
        ...
        assert predictions.size() == nodeCount :
                "predictions.size() = " + predictions.size() + " <> " + nodeCount + " = nodeCount!";
    }
}
