...
public class TicTacToeBoardImpl_Ng implements TicTacToeBoard {
	...
	*/
    ...
    private boolean noTurnsPlayedAfterWin() {
        ...
        if ((isAWinner(Mark.X) || isAWinner(Mark.O)) && marksPlayed < movesArray.length - ARRAY_OVERFLOW_OFFSET) {
    ...
    */
    private boolean threeOfAKind(List<Integer> normalisedList) {
        Map<Object, Long> occurrences =
                normalisedList.stream().collect(Collectors.groupingBy(c -> c, Collectors.counting()));
    ...
    */
    ...
    public String toString() {
        ...
        List<Integer> sortedMovesList =
                Arrays.stream(movesArray).boxed().filter(i -> i != NO_MOVE).collect(Collectors.toList());
